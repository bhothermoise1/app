...
<div class="container" style="margin-right: 10%;">
	<div class="col-sm-12" >
		<br>
		<h2 style="text-align: center;"> Gestion de Docentes <img src="../img/user_admin.png"/></h2>
		<br>
<caption>
<a href="in_user_admin.php" class="btn btn-success"><i class="fas fa-plus"></i> Agregar Nuevo</a>
</caption> 
...
<tbody  class="ml-auto" >
			<?php 
			$sql="SELECT `id_doc_u`,  `correo`, `pass`,`grado`,`periodo` FROM `user_docente`";
			...
			<tr>
				...
				<td>
				<a href="up_user.php?id=<?php echo $ver[0]; ?>"  class="btn btn-warning" ><i class="fas fa-pencil-alt"></i> </a> 
				</td>
				
				<td><a class="btn btn-danger" href="../procesos/eliminar_doc_user.php?id=<?php echo $ver[0]; ?>" onclick=" return confirm('Estas seguro que quiere eliminar este registro ?') ; "><i class="fas fa-user-times" 
				></i></a>  
