...
<div class="container" style="margin-right: 10%;">
	<div class="col-sm-12" >
		<br>
		<h2 style="text-align: center;"><img src="../img/id_worker.png"/> Lista de Estudiantes 
			<img src="../img/student.png"/></h2>
		<br>
<caption>
<a href="in_pro.php" class="btn btn-warning"><i class="fas fa-plus"></i> Agregar Nuevo</a>
</caption> 
...
<tbody  class="ml-auto" >
			...
			<tr>
				...
				<td>
				<a href="up_in_ob_admin.php?id=<?php echo $ver[0]; ?>"  class="btn btn-warning" ><i class="fas fa-pencil-alt"></i> </a> 
				</td>
				
				<td><a class="btn btn-danger" href="eliminar_admin.php?id=<?php echo $ver[0]; ?>" onclick=" return confirm('Are you sure you want to delete this ?') ; "><i class="fas fa-user-times" 
				></i></a>  
