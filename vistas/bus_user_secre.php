...
<tbody  class="ml-auto" >
			...
			<tr>
				...
				<td><a class="btn btn-danger" href="../procesos/eliminar_secre_user.php?id=<?php echo $ver[0]; ?>" onclick=" return confirm('Estas seguro que quiere eliminar este registro ?') ; "><i class="fas fa-user-times" 
				></i></a>  
