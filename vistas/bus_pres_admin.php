...
<div class="container" style="margin-right: 10%;">
	<div class="col-sm-12" >
		<br>
		<h2 style="text-align: center;"><img src="../img/toy2.png"/> Lista de Pre-escolar <img src="../img/toy3.png"/></h2>
		<br>
<caption>
<a href="in_pres_admin.php" class="btn btn-warning"><i class="fas fa-plus"></i> Agregar Nuevo</a>
</caption> 
...
<tbody  class="ml-auto" >
			...
			<tr>
			    ...
			    <td><?php echo $ver[5]?></td>
			        ...
			        <td>
				<a href="preescolar/pdf/reporteprofesionales.php?id=<?php echo $ver[0]; ?>"  class="btn btn-success" ><i class="far fa-file-pdf"></i></a> 
				</td>
				<td>
