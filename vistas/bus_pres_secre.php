...
<div class="container" style="margin-right: 10%;">
	<div class="col-sm-12" >
		<br>
		<h2 style="text-align: center;"><img src="../img/id_worker.png"/> Lista de Preescolar <img src="../img/teacher1.png"/><img src="../img/teacher2.png"/></h2>
		<br>
<caption>
<a href="in_pres_secre.php" class="btn btn-warning"><i class="fas fa-plus"></i> Agregar Nuevo</a>
</caption> 
...
<tbody  class="ml-auto" >
			<?php 
			$sql="SELECT `id_pres`,  `name_pres`, `sexo_pres`,`edad_pres`,`periodo_pres`,`nivel_pres` FROM `alum_pres`";
			...
			<tr>
			    ...
			    <td><?php echo $ver[5]?></td>
			        ...
			        <td>
				<a href="estudiantes/pdf/reporteprofesionales.php?id=<?php echo $ver[0]; ?>"  class="btn btn-success" ><i class="far fa-file-pdf"></i></a> 
				</td>
				<td>
				<a href="up_pres_admin.php?id=<?php echo $ver[0]; ?>"  class="btn btn-warning" ><i class="fas fa-pencil-alt"></i> </a> 
				</td>
				
				<td><a class="btn btn-danger" href="../procesos/eliminar_secre_pres.php?id=<?php echo $ver[0]; ?>" onclick=" return confirm('Estas seguro que quiere eliminar este registro ?') ; "><i class="fas fa-user-times" 
				></i></a>  
