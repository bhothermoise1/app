...
<li><a href="../procesos/salir.php"><i class="fas fa-sign-out-alt"></i>Salir</a></li>		
	...
	<div class="ul">
		...
		<div class="li">
			<a class="a" href="bus_pres_admin.php">
				<div class="icon">
		...
		<div class="li">
			<a class="a" href="admin_ico.php">
				<div class="icon">
					 <i class="fas fa-arrow-circle-left" aria-hidden="true"></i>
					 <i class="fas fa-arrow-circle-left" aria-hidden="true"></i>
					</div>
					<div class="name" data-text="Home" ><span>Regresar</span> </div>
...
<main>
	...
	<div class="main-menu" >
		...
		<a href="bus_pres_admin.php">
			<div class="option">
				<img src="../img/toy3.png">
				<h2>Pre-escolar</h2>
			</div>
		</a>
		<a href="admin_ico.php">
			<div class="option">
				<img src="../img/go_back.png">
				<h2> Regresar</h2>
			</div>
		</a>
</main>
