...
<br><br><br><br>
	...
	<form class="formulario-login"  method="POST" action="../procesos/insert_user_secre.php" >

	<h1 class="h1"> <img src="../img/secretary3.png"/> Registrar Secretaria</h1>
		<div class="contenedor-login">

			<div class="input-contenedor-login">
				<i class="fas fa-user-tie"></i>
				<input type="text" name="correo" id="correo" placeholder="Usuario Secretaria" class="input-l" maxlength="10">
			</div>
