...
<tbody  class="ml-auto" >
			...
			<tr>
				...
				<td><a class="btn btn-danger" href="eliminar.php?id=<?php echo $ver[0]; ?>" onclick=" return confirm('Estas seguro que quiere eliminar este registro ?') ; "><i class="fas fa-user-times" 
				></i></a>  
...
<div class="container">
  <a class="btn btn-danger btn-lg" style="margin-top: -80px;"  href="admin_ico_per.php"> <i class="fas fa-arrow-circle-left"></i> </a>
</div>
