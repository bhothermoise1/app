		...
		<div class="col-sm-12">
						...
						<tbody class="ml-auto">
							...
							?>
								<tr>
									...
									<td><a class="btn btn-danger" href="eliminar.php?id=<?php echo $ver[0]; ?>" onclick=" return pila();"><i class="fas fa-user-times"></i></a>
			...
			<script type="text/javascript">
				function pila() {
					...
					alertify.confirm(
						"<center>¿ Desea eliminar registro? </center><img  src='../img/successful2.pngstyle='margin-left:160px;'>",
						function() {
							return false
						}
					);
